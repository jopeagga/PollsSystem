      ...
      <section>
        <div class="row g-0">
            ...
            <div class="col-lg-5 bg-dark d-flex flex-column align-items-end min-vh-100">
                ...
                <h1 class="font-weight text-center mt-3 mb-5">INICIA SESION</h1>
                 <form class="mb-5" action="login.php" method="post">
                    ...
                    <a type="submit" class="btn btn_iniSes w-100" href="principal.html">Iniciar sesión</a>
                  </form>
                  <center>
                    <p class="text-light text-center font-weight text-decoration-none mb-0">¿Aun no tienes cuenta?</p> <a href="registro.html" class="text-light text-center font-weight">Crea una ahora</a>
                  </center>
                    </div>
            </div>
        </div>
