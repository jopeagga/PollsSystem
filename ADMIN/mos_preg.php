            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <button class=" float-right btn_Deta btn-bloc" id="boton_agregar">
                  AÑADIR PREGUNTA
                </button>
                <div class="col-md-12">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
              <h4 class="modal-title">AÑADIR UNA PREGUNTA</h4>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="agregarPregunta()">AÑADIR PREGUNTA</button>
            </div>
...
<div class="modal fade" id="modal_modificar" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                <button type="button" class="btn btn-success" onclick="modificarDetallesPregunta()">GUARDAR CAMBIOS</button>
